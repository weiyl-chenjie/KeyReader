...
#
# Created: Fri Oct 11 16:47:45 2019
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1229, 1012)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.groupBox_show_image = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox_show_image.setGeometry(QtCore.QRect(290, 190, 901, 661))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        ...
        self.label_show_image.setGeometry(QtCore.QRect(9, 29, 851, 621))
        ...
        self.widget.setGeometry(QtCore.QRect(10, 40, 231, 182))
        ...
        self.widget1.setGeometry(QtCore.QRect(10, 390, 189, 225))
        self.widget1.setObjectName("widget1")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget1)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.pushButton_set_calibration_line = QtWidgets.QPushButton(self.widget1)
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.pushButton_self_calibrate = QtWidgets.QPushButton(self.widget1)
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.pushButton_manual_calibrate = QtWidgets.QPushButton(self.widget1)
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        self.pushButton_check_image = QtWidgets.QPushButton(self.widget1)
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(16)
        ...
        QtCore.QObject.connect(self.pushButton_check_image, QtCore.SIGNAL("clicked()"), MainWindow.capture)
